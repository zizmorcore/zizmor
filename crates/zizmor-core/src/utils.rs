...
pub static BASH: LazyLock<tree_sitter::Language> =
    LazyLock::new(|| tree_sitter_bash::LANGUAGE.into());

pub static PWSH: LazyLock<tree_sitter::Language> =
...
pub fn split_patterns(patterns: &str) -> impl Iterator<Item = &str> {
...
pub fn parse_fenced_expressions_from_routable<
    'a,
    'doc,
...
pub fn normalize_shell(shell: &str) -> &str {
...
pub fn bash_parser() -> tree_sitter::Parser {
...
pub fn pwsh_parser() -> tree_sitter::Parser {
    let mut parser = tree_sitter::Parser::new();
    parser
        .set_language(&PWSH)
...
impl SpannedQuery {
    pub fn new(query: &'static str, language: &tree_sitter::Language) -> Self {
