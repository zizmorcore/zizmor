...
pub struct SymbolicLocation<'doc> {
    ...
    pub feature_kind: SymbolicFeature<'doc>,
...
impl<'doc> SymbolicLocation<'doc> {
    #[must_use]
    pub fn with_keys(&self, keys: impl IntoIterator<Item = yamlpath::Component<'doc>>) -> Self {
        SymbolicLocation {
            key: self.key,
    ...
    pub fn subfeature(mut self, subfeature: subfeature::Subfeature<'doc>) -> Self {
    ...
    pub fn annotated(mut self, annotation: impl Into<Cow<'doc, str>>) -> Self {
    ...
    pub fn concretize(self, document: &'doc yamlpath::Document) -> anyhow::Result<Location<'doc>> {
...
pub struct ConcreteLocation {
    ...
    pub end_point: Point,
    pub offset_span: Range<usize>,
}

impl ConcreteLocation {
    pub fn new(start_point: Point, end_point: Point, offset_span: Range<usize>) -> Self {
        Self {
            start_point,
            end_point,
            offset_span,
    ...
    pub fn from_span(span: Range<usize>, doc: &yamlpath::Document) -> Self {
...
#[serde(transparent)]
pub struct Comment<'doc>(&'doc str);
...
impl Comment<'_> {
    ...
    pub fn ignores(&self, rule_id: &str) -> bool {
...
impl<'doc> Feature<'doc> {
    ...
    pub fn from_span<'a>(span: &Range<usize>, input: &'a impl AsDocument<'a, 'doc>) -> Self {
...
#[derive(Serialize)]
pub struct Location<'doc> {
    /// The symbolic workflow location.
    pub symbolic: SymbolicLocation<'doc>,
    /// The concrete location, including extracted feature.
    pub concrete: Feature<'doc>,
}

impl<'doc> Location<'doc> {
    pub fn new(symbolic: SymbolicLocation<'doc>, concrete: Feature<'doc>) -> Self {
