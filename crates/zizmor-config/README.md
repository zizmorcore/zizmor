...
[![Crates.io](https://img.shields.io/crates/v/zizmor-config)](https://crates.io/crates/zizmor-config)
[![docs.rs](https://img.shields.io/docsrs/zizmor-config)](https://docs.rs/zizmor-config)
...
Configuration support for [zizmor].
