...
fn render_finding(registry: &InputRegistry, finding: &Finding, show_urls_mode: &ShowUrlsMode) {
    ...
    if matches!(show_urls_mode, ShowUrlsMode::Always) {
